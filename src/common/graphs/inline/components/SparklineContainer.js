...
export default class SparklineContainer extends React.Component {
  barChart($el) {
    ...
    const sparklineNegBarColor =
      $el.data('sparkline-negbar-color') || '#A90329';
  ...
  lineChart($el) {
    ...
    const thishighlightSpotColor =
      $el.data('sparkline-highlightspot-color') || '#50f050';
    const thisHighlightLineColor =
  ...
  boxChart($el) {
    ...
    const thisBoxOutlineColor =
      $el.data('sparkline-outline-color') || '#303030';
    const thisBoxOutlineFill =
      $el.data('sparkline-outlinefill-color') || '#f0f0f0';
    const thisBoxMedianColor =
      $el.data('sparkline-outlinemedian-color') || '#f00000';
    const thisBoxTargetColor =
  ...
  bulletChart($el) {
    ...
    const thisBulletPerformanceColor =
      $el.data('sparkline-performance-color') || '#3030f0';
    const thisBulletRangeColors = $el.data('sparkline-bulletrange-color') || [
      '#d3dafe',
      '#a8b6ff',
      '#7f94ff',
    ];
  ...
  discreteChart($el) {
    ...
    const thisDiscreteThrusholdColor =
  ...
  tristaneChart($el) {
    ...
    const thisTristatePosBarColor =
      $el.data('sparkline-posbar-color') || '#60f060';
    const thisTristateNegBarColor =
      $el.data('sparkline-negbar-color') || '#f04040';
    const thisTristateZeroBarColor =
  ...
  compositeLineChart($el) {
    ...
    const thishighlightSpotColor1 = $el.data(
      'sparkline-highlightspot-color-top',
    ); //  || '#50f050';
    const thisHighlightLineColor1 = $el.data(
      'sparkline-highlightline-color-top',
    ); // || '#f02020';
    const thishighlightSpotColor2 = $el.data(
      'sparkline-highlightspot-color-bottom',
    ); // || thishighlightSpotColor1;
    const thisHighlightLineColor2 = $el.data(
